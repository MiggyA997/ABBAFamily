...
(function () {
  ...
  var translations = {
    en: {
      // Document
      "document.title": "ABBA Family Therapy | ABA Therapy in Miami-Dade & Broward",
      "meta.description":
        "Individualized, evidence-based ABA Therapy services that help children with autism and ADHD learn, grow, and reach their fullest potential. Bilingual care in English and Spanish, serving families across Miami-Dade and Broward, FL.",
      ...
      "about.p1":
        "I'm a BCBA and the founder of ABBA Family Therapy. I started this practice with a vision of something more personal, more intentional, more family-centered. Families shouldn't feel like just another case, and care should feel as meaningful in everyday life as it looks on paper. Clinical quality and human connection belong together.",
      "about.p2":
        "If you're up at 9pm thinking about your child, that thoughtfulness already says so much. The parents we work with love their children deeply and are looking for a steady partner to help navigate the ocean of information. That's exactly who ABBA Family was built to serve.",
      "about.tagline":
        "We figure it out together, one step at a time. You always have a steady partner beside you.",
      ...
      // Services
      "services.heading": "Our ABA Therapy Services",
      "services.intro":
      ...
      "services.community.title": "Community-Based ABA Therapy",
      ...
      "services.parent.body":
        "Real progress lives in everyday moments, where you and your child spend most of your time. We train and coach you alongside the work, so the strategies are yours to use anytime. Parents are essential partners in your child's growth.",
      ...
      // Why ABBA
      "why.heading": "Why Choose ABBA Family",
      "why.intro": "What you can expect from us, every day.",
      "why.1.title": "Immediate, compassionate response",
      "why.1.body":
        "Every time you reach out, you'll hear back from a real person within one business day.",
      ...
      "why.3.body":
        "ABBA Family means God the Father. Faith shapes how we see people, with patience, humility, and compassion. You'll feel it in how we care for your family.",
      "why.4.title": "Plans that adjust as your child grows",
      "why.4.body":
        "Every child is unique. The plan is individualized from day one and grows alongside your child. What helps one child may look different for another, and we customize every approach.",
      "why.5.title": "Bilingual: English & Español",
      "why.5.body":
        "Sessions, intake calls, and family meetings happen in whichever language feels most comfortable. Your home language is always welcomed and celebrated.",
      ...
      "how.1.title": "Assess",
      "how.1.body":
        "We start with questions and stories. Your child's age, diagnosis, hopes, goals, your insurance. Every question is welcome. We take the time to understand the whole child, strengths, personality, and all.",
      "how.2.title": "Plan",
      "how.2.body":
        "Based on the initial assessment, we design an individualized plan with goals tailored to your child. We explain the strategy clearly. Parents are involved from the start, because plans work best when families understand and own them together.",
      ...
      "how.4.body":
        "We track every step. We celebrate the small wins. We're transparent about what we see and adjust the plan as your child grows. Progress takes many forms, and we share every one of them with you.",
      ...
      "faq.a1":
        "We work with most private insurance plans. The first call usually covers your insurance information along with your child's age, diagnosis, and what's bringing you here. Every question is welcome, and we'll walk you through every part of the process.",
      "faq.q2": "What ages and conditions do you serve?",
      "faq.a2":
        "We work primarily with children diagnosed with autism (ASD) or ADHD. Other developmental concerns may also be eligible. The earlier we start the better, and any time is the right time to begin.",
      ...
      "faq.a5":
        "Yes, and we love when parents are part of the journey. As BCBAs, we work hand-in-hand with parents because you're the one who knows your child best. You're also the one who carries the progress into every part of daily life. The more consistent the strategies are at home and in sessions, the more your child thrives. We'll train and coach you alongside the work, so you have everything you need.",
      ...
      "cta.body":
        "Take it one step at a time. Send a question, share what's on your mind, or simply say \u201cI'd like to learn more.\u201d We walk this journey with you, together.",
    ...
    es: {
      // Document
      "document.title":
        "ABBA Family Therapy | Terapia ABA en Miami-Dade y Broward",
      "meta.description":
        "Servicios de Terapia ABA individualizados y basados en evidencia que ayudan a niños con autismo y TDAH a aprender, crecer y alcanzar su máximo potencial. Atención bilingüe en inglés y español, sirviendo a familias en Miami-Dade y Broward, FL.",
      ...
      "about.p1":
        "Soy BCBA y fundadora de ABBA Family Therapy. Comencé esta práctica con una visión: algo más personal, más intencional, más centrado en la familia. Las familias merecen sentirse verdaderamente vistas, con un cuidado que se sienta tan significativo en la vida diaria como se ve en el papel. La calidad clínica y la conexión humana van de la mano.",
      "about.p2":
        "Si está despierta a las 9 de la noche pensando en su hijo, esa atención ya dice mucho. Los padres con quienes trabajamos aman profundamente a sus hijos y buscan un compañero firme que les ayude a navegar el océano de información. ABBA Family fue creada precisamente para servir a familias como la suya.",
      "about.tagline":
        "Lo resolvemos juntos, paso a paso. Siempre tiene un compañero firme a su lado.",
      ...
      // Services
      "services.heading": "Nuestros Servicios de Terapia ABA",
      "services.intro":
      ...
      "services.community.title": "Terapia ABA en la Comunidad",
      "services.community.body":
      ...
      "services.parent.body":
        "El verdadero progreso vive en los momentos cotidianos, donde usted y su hijo pasan la mayor parte del tiempo. Le entrenamos y le acompañamos junto al trabajo, para que las estrategias sean suyas y pueda usarlas en cualquier momento. Los padres son aliados esenciales en el crecimiento de su hijo.",
      "services.es.title": "Servicios en Español",
      "services.es.body":
        "En ABBA Family Therapy, ofrecemos servicios completamente en español para familias hispanohablantes. Comunicarse con nosotros en su idioma es completamente bienvenido.",

      // Why ABBA
      "why.heading": "Por Qué Elegir ABBA Family",
      "why.intro": "Lo que puede esperar de nosotros, cada día.",
      "why.1.title": "Respuesta inmediata y compasiva",
      "why.1.body":
        "Cada vez que se comunique con nosotros, recibirá respuesta de una persona real en menos de un día hábil.",
      ...
      "why.3.body":
        "ABBA Family significa Dios el Padre. La fe da forma a cómo vemos a las personas, con paciencia, humildad y compasión. Lo sentirá en cómo cuidamos a su familia.",
      "why.4.title": "Planes que se ajustan a medida que su hijo crece",
      "why.4.body":
        "Cada niño es único. El plan es individualizado desde el primer día y crece junto con su hijo. Lo que ayuda a un niño puede verse diferente para otro, y personalizamos cada enfoque.",
      "why.5.title": "Bilingüe: English & Español",
      "why.5.body":
        "Las sesiones, llamadas iniciales y reuniones familiares se realizan en el idioma que se sienta más cómodo. El idioma de su hogar siempre es bienvenido y celebrado.",
      ...
      "how.1.title": "Evaluar",
      "how.1.body":
        "Comenzamos con preguntas y conversaciones. La edad de su hijo, el diagnóstico, sus esperanzas, sus metas, su seguro. Toda pregunta es bienvenida. Nos tomamos el tiempo para entender al niño completo, sus fortalezas, su personalidad, y todo lo demás.",
      "how.2.title": "Planificar",
      "how.2.body":
        "Basándonos en la evaluación inicial, diseñamos un plan individualizado con metas adaptadas a su hijo. Le explicamos la estrategia con claridad. Los padres participan desde el inicio, porque los planes funcionan mejor cuando las familias los entienden y los hacen suyos juntos.",
      ...
      "how.4.body":
        "Hacemos seguimiento de cada paso. Celebramos las pequeñas victorias. Somos transparentes sobre lo que vemos y ajustamos el plan a medida que su hijo crece. El progreso toma muchas formas, y compartimos cada una con usted.",
      ...
      "faq.a1":
        "Trabajamos con la mayoría de planes de seguro privados. La primera llamada usualmente cubre la información de su seguro junto con la edad de su hijo, el diagnóstico y qué le trae aquí. Toda pregunta es bienvenida, y le acompañamos en cada parte del proceso.",
      "faq.q2": "¿Qué edades y condiciones atienden?",
      "faq.a2":
        "Trabajamos principalmente con niños diagnosticados con autismo (TEA) o TDAH. Otras preocupaciones del desarrollo también pueden ser elegibles. Mientras antes empecemos mejor, y cualquier momento es el momento adecuado para comenzar.",
      ...
      "faq.a5":
        "Sí, y nos encanta cuando los padres son parte del camino. Como BCBA, trabajamos mano a mano con los padres porque usted es quien mejor conoce a su hijo. También es quien lleva el progreso a cada parte de la vida diaria. Cuanto más consistentes sean las estrategias en casa y en las sesiones, más prospera su hijo. Le entrenamos y le acompañamos junto al trabajo, para que tenga todo lo que necesita.",
      "faq.q6": "¿Ofrecen servicios en español?",
      "faq.a6":
        "Sí. Hablamos español y trabajamos con muchas familias hispanohablantes. Comunicarse con nosotros en su idioma es completamente bienvenido.",
      ...
      "cta.body":
        "Vaya paso a paso. Envíe una pregunta, comparta lo que tiene en mente, o simplemente diga \u201cMe gustaría saber más.\u201d Caminamos este viaje con usted, juntos.",
